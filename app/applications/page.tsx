  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffaf7_0%,#f8fafc_40%,#f5f7fb_100%)] p-4 md:p-8">
      <div className="max-w-[1600px] mx-auto">
          ...
          <div className="xl:col-span-3">
            <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="sticky bottom-0 -mx-5 flex flex-col gap-3 border-t bg-white/95 px-5 py-4 backdrop-blur md:static md:mx-0 md:border-t-0 md:bg-transparent md:px-0 md:py-0 md:flex-row md:flex-wrap">
                  <button
                    onClick={() => setOpenNewDialog(true)}
        ...
        >
          <DialogContent className="flex h-[92vh] w-[95vw] max-w-3xl flex-col overflow-hidden rounded-[28px] p-0 md:max-h-[90vh] md:h-auto">
            {selectedCard && (
              <>
                ...
                <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4 space-y-5 md:px-6 md:py-5">
